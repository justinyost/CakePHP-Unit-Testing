 ...
 */
	public function <?php echo $admin ?>index() {
		...
		$<?php echo $pluralName; ?> = $data = $this->paginate();	
		$this->set(compact('<?php echo $pluralName; ?>', 'data'));
 ...
 */
	public function <?php echo $admin ?>view($id = null) {
		...
		$<?php echo $pluralName; ?> = $data = $this-><?php echo $currentModelName; ?>->find('first', $options);
		$this->set(compact('<?php echo $pluralName; ?>', 'data'));
		$this->response->statusCode(200);
		return $this->response;
	}
